...
<body id="updatePassword">
    ...
    <div class="col-sm-5">
        <form method="post" id="updatePassword"
            action="<c:url value='/updatePassword'/>" class="well"
            autocomplete="off">

            <div class="form-group">
                <label class="control-label"><fmt:message
                        key="user.username" /></label> <input type="text"
            ...
            <c:choose>
                <c:when test="${not empty token}">
                    <input type="hidden" name="token"
                        value="<c:out value="${token}" escapeXml="true" />" />
                </c:when>
                <c:otherwise>
                    <div class="form-group">
                        <label class="control-label"><fmt:message
            ...
            <div class="form-group">
                <label class="control-label"><fmt:message
                        key="updatePassword.newPassword.label" /></label> <input
