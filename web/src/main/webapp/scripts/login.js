...
function required() {
    this.aa = new Array("j_username", "<fmt:message key='errors.required'><fmt:param><fmt:message key='label.username'/></fmt:param></fmt:message>",
            new Function("varName", " return this[varName];"));
    this.ab = new Array("j_password", "<fmt:message key='errors.required'><fmt:param><fmt:message key='label.password'/></fmt:param></fmt:message>",
            new Function("varName", " return this[varName];"));
}
