 ...
 * http://displaytag.sourceforge.net/xref-test/org/displaytag/filter/
 * MockFilterSupport.html
 *
 * Todo: look into using Spring's MockFilterChain:
 * http://www.springframework.org/docs/api/org/springframework/mock/web/
